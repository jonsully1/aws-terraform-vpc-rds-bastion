...
dependency "rds_security_group" {
  ...
  mock_outputs = {
    ...
    rds_postgres_db_security_group_id = "sg-12345679"
  }
}
...
inputs = merge(
  local.env_vars.inputs,
  {
    ...
    rds_postgres_db_security_group_id = dependency.rds_security_group.outputs.rds_postgres_db_security_group_id,
  }
)
